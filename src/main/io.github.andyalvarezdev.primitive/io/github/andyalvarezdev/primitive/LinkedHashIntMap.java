 ...
 *
 * <p>A special {@link #LinkedHashIntMap(int,float,boolean) constructor} is
 ...
 * backing map.
 *
 * <p>The {@link #removeEldestEntry(IntMap.Entry)} method may be overridden to
        ...
        implements IntMap<V>
{
    ...
    static class Entry<V> extends Node<V> {
        ...
        Entry(int hash, int key, V value, Node<V> next) {
    ...
    final class LinkedKeySet extends AbstractIntSet {
        ...
        public final void clear()               { LinkedHashIntMap.this.clear(); }
    ...
    final class LinkedEntrySet extends AbstractSet<IntMap.Entry<V>> {
        public final int size()                 { return size; }
        public final void clear()               { LinkedHashIntMap.this.clear(); }
