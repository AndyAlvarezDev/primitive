...
public class LinkedHashIntSet
     ...
     */
    public LinkedHashIntSet(int initialCapacity, float loadFactor) {
     ...
     *              than zero
     */
    public LinkedHashIntSet(int initialCapacity) {
     ...
     */
    public LinkedHashIntSet(IntCollection c) {
