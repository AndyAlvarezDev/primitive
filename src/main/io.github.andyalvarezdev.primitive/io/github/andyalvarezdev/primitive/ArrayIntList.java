        ...
        implements IntList, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     *
     * @param o the item
     * @return the index where the o is
     */
    ...
    public boolean equals(Object o) {
        ...
        boolean equal = (o.getClass() == ArrayIntList.class)
                ? equalsArrayList((ArrayIntList) o)
                : equalsRange((IntList) o, 0, size);

        checkForComodification(expectedModCount);
        return equal;
    }

    boolean equalsRange(IntList other, int from, int to) {
        final int[] es = elementData;
        if (to > es.length) {
        ...
        for (; from < to; from++) {
            if (!oit.hasNext() || es[from] != oit.nextInt()) {
                return false;
            }
        }
        return !oit.hasNext();
    ...
    private boolean equalsArrayList(ArrayIntList other) {
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        if (size > 0) {
            ...
            SharedSecrets.getJavaObjectInputStreamAccess().checkArray(s, int[].class, size);
    ...
    private class Itr implements PrimitiveIterator.OfInt {
        ...
        public int nextInt() {
            ...
            int[] elementData = ArrayIntList.this.elementData;
    ...
    private class ListItr extends Itr implements IntListIterator {
        ...
        public void set(int e) {
            ...
            try {
                ArrayIntList.this.set(lastRet, e);
            } catch (IndexOutOfBoundsException ex) {
                throw new ConcurrentModificationException();
            }
        }
    ...
    private static class SubList extends AbstractIntList implements RandomAccess {
        private final ArrayIntList root;
         ...
         */
        public SubList(ArrayIntList root, int fromIndex, int toIndex) {
            this.root = root;
            this.parent = null;
        ...
        public boolean equals(Object o) {
            ...
            boolean equal = root.equalsRange((IntList)o, offset, offset + size);
            checkForComodification();
            return equal;
        }
        ...
        public Spliterator.OfInt spliterator() {
            ...
            return new Spliterator.OfInt() {
                ...
                public ArrayIntList.ArrayListSpliterator trySplit() {
    ...
    private void replaceAllRange(IntUnaryOperator operator, int i, int end) {
