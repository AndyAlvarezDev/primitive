 ...
 * @see     Hashtable
 */
public class HashIntMap<V> extends AbstractIntMap<V>
     ...
     */
    final void putMapEntries(IntMap<? extends V> m, boolean evict) {
        int s = m.size();
        if (s > 0) {
     ...
     */
    final V putVal(int hash, int key, V value, boolean onlyIfAbsent,
                   boolean evict) {
     ...
     * @return the node, or null if none
     */
    final Node<V> removeNode(int hash, int key, Object value,
                               boolean matchValue, boolean movable) {
        Node<V>[] tab; Node<V> p; int n, index;
        if ((tab = table) != null && (n = tab.length) > 0 &&
                (p = tab[index = (n - 1) & hash]) != null) {
            Node<V> node = null, e; int k; V v;
            if (p.hash == hash &&
                    ((k = p.key) == key ))
                node = p;
    ...
    final class KeySet extends AbstractIntSet {
        ...
        public final void clear()               { HashIntMap.this.clear(); }
        ...
        public final Spliterator.OfInt spliterator() {
            return new KeySpliterator<>(HashIntMap.this, 0, -1, 0, 0);
        }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public final Spliterator<V> spliterator() {
            return new ValueSpliterator<>(HashIntMap.this, 0, -1, 0, 0);
        }
    ...
    final class EntrySet extends AbstractSet<IntMap.Entry<V>> {
        public final int size()                 { return size; }
        public final void clear()               { HashIntMap.this.clear(); }
        public final Iterator<IntMap.Entry<V>> iterator() {
        ...
        public final Spliterator<IntMap.Entry<V>> spliterator() {
            return new EntrySpliterator<>(HashIntMap.this, 0, -1, 0, 0);
        }
        public final void forEach(Consumer<? super IntMap.Entry<V>> action) {
            Node<V>[] tab;
            if (action == null)
                throw new NullPointerException();
            if (size > 0 && (tab = table) != null) {
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        if (mappings < 0)
            ...
            SharedSecrets.getJavaObjectInputStreamAccess().checkArray(s, IntMap.Entry[].class, cap);
            @SuppressWarnings({"rawtypes","unchecked"})
    ...
    final class EntryIterator extends HashIterator
        ...
        public final IntMap.Entry<V> next() { return nextNode(); }
    }
    ...
    static class HashMapSpliterator<V> {
        ...
        HashMapSpliterator(HashIntMap<V> m, int origin,
                           int fence, int est,
    ...
    static final class KeySpliterator<V>
        ...
        KeySpliterator(HashIntMap<V> m, int origin, int fence, int est,
                       int expectedModCount) {
    ...
    static final class ValueSpliterator<V>
        ...
        ValueSpliterator(HashIntMap<V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class EntrySpliterator<V>
        ...
        EntrySpliterator(HashIntMap<V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
     ...
     * linked node.
     */
    static final class TreeNode<V> extends LinkedHashIntMap.Entry<V> {
         ...
         * this node.
         */
        final Node<V> untreeify(HashIntMap<V> map) {
         ...
         */
        final TreeNode<V> putTreeVal(HashIntMap<V> map, Node<V>[] tab,
                                       int h, int k, V v) {
            Class<?> kc = null;
         ...
         */
        final void removeTreeNode(HashIntMap<V> map, Node<V>[] tab,
                                  boolean movable) {
            int n;
         ...
         */
        final void split(HashIntMap<V> map, Node<V>[] tab, int index, int bit) {
            TreeNode<V> b = this;
