...
public abstract class AbstractIntIntMap implements IntIntMap {
    ...
    public int remove(int key) {
        ...
        int oldValue = DEFAULT_INT_VALUE;
    ...
    public IntSet keySet() {
        ...
        if (ks == null) {
            ks = new AbstractIntSet() {
                ...
                public boolean isEmpty() {
                    return AbstractIntIntMap.this.isEmpty();
                }

                public void clear() {
                    AbstractIntIntMap.this.clear();
                }
    ...
    public IntCollection values() {
        IntCollection vals = values;
        if (vals == null) {
            vals = new AbstractIntCollection() {
                public PrimitiveIterator.OfInt iterator() {
                    return new PrimitiveIterator.OfInt() {
                        private Iterator<Entry> i = entrySet().iterator();
        ...
        try {
            for (Entry e : entrySet()) {
                ...
                if (value == DEFAULT_INT_VALUE) {
                    if (!(m.get(key) == DEFAULT_INT_VALUE && m.containsKey(key)))
                        return false;
                } else {
                    if (value != m.get(key))
                        return false;
