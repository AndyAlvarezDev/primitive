 ...
 * have no effect on the map.  For example, invoking the {@link #putAll(IntMap)}
...
public interface IntMap<V> {
     ...
     */
     interface Entry<V> {
         ...
         * @since 1.8
         */
        public static <V> Comparator<Entry<V>> comparingByKey(IntComparator cmp) {
     ...
     * @since 1.8
     */
    default void forEach(IntBiConsumer<? super V> action) {
     ...
     * @since 1.8
     */
    default void replaceAll(IntBiFunction<? super V, ? extends V> function) {
     ...
     * @since 1.8
     */
    default V computeIfPresent(int key,
     ...
     * @since 1.8
     */
    default V merge(int key, V value,
     ...
     * @since 9
     */
    static <V> IntMap<V> of(int k1, V v1) {
        return new Containers.IntMap1<>(k1, v1);
    }
     ...
     * @since 2.0
     */
    static <V> Entry<V> entry(int k, V v) {
        // KeyValueHolder checks for nulls
        return new IntKeyValue<>(k, v);
    }
}
