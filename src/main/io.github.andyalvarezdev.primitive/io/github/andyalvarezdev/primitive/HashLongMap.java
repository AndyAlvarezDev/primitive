...
import io.github.andyalvarezdev.primitive.function.LongBiConsumer;
import io.github.andyalvarezdev.primitive.function.LongBiFunction;
 ...
 * @see     Hashtable
 */
public class HashLongMap<V> extends AbstractLongMap<V>
     ...
     */
    public HashLongMap(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public HashLongMap(int initialCapacity) {
     ...
     */
    public HashLongMap(LongMap<? extends V> m) {
     ...
     */
    final void putMapEntries(LongMap<? extends V> m, boolean evict) {
        int s = m.size();
        if (s > 0) {
    ...
    final Node<V> getNode(int hash, long key) {
        Node<V>[] tab; Node<V> first, e; int n; int k;
    ...
    final class KeySet extends AbstractLongSet {
        public final int size()                 { return size; }
        public final void clear()               { HashLongMap.this.clear(); }
        public final PrimitiveIterator.OfLong iterator()     { return new KeyIterator(); }
        public final boolean contains(int o) { return containsKey(o); }
        public final boolean remove(int key) {
            return removeNode(hash(key), key, null, false, true) != null;
        }
        public final Spliterator.OfLong spliterator() {
            return new KeySpliterator<>(HashLongMap.this, 0, -1, 0, 0);
        }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public final Spliterator<V> spliterator() {
            return new ValueSpliterator<>(HashLongMap.this, 0, -1, 0, 0);
        }
    ...
    final class EntrySet extends AbstractSet<Entry<V>> {
        ...
        public final Spliterator<Entry<V>> spliterator() {
            return new EntrySpliterator<>(HashLongMap.this, 0, -1, 0, 0);
        }
    ...
    @Override
    public Object clone() {
        HashLongMap<V> result;
        try {
            result = (HashLongMap<V>)super.clone();
    ...
    final class KeyIterator extends HashIterator
        ...
        public final long nextLong() { return nextNode().key; }
    }
    ...
    static class HashMapSpliterator<V> {
        ...
        HashMapSpliterator(HashLongMap<V> m, int origin,
                           int fence, int est,
    ...
    static final class KeySpliterator<V>
        ...
        KeySpliterator(HashLongMap<V> m, int origin, int fence, int est,
                       int expectedModCount) {
    ...
    static final class ValueSpliterator<V>
        ...
        ValueSpliterator(HashLongMap<V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class EntrySpliterator<V>
        ...
        EntrySpliterator(HashLongMap<V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
     ...
     * linked node.
     */
    static final class TreeNode<V> extends LinkedHashLongMap.Entry<V> {
         ...
         * comparing keys.
         */
        final TreeNode<V> find(int h, long k, Class<?> kc) {
            TreeNode<V> p = this;
            do {
                int ph, dir;
                long pk;
         ...
         */
        final TreeNode<V> getTreeNode(int h, long k) {
         ...
         * this node.
         */
        final Node<V> untreeify(HashLongMap<V> map) {
         ...
         */
        final TreeNode<V> putTreeVal(HashLongMap<V> map, Node<V>[] tab,
                                     int h, long k, V v) {
            Class<?> kc = null;
         ...
         */
        final void removeTreeNode(HashLongMap<V> map, Node<V>[] tab,
                                  boolean movable) {
            int n;
         ...
         */
        final void split(HashLongMap<V> map, Node<V>[] tab, int index, int bit) {
            TreeNode<V> b = this;
